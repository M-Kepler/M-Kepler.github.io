...
- [HTTP/1.0](#http10)
  ...
  - [2.2 请求格式](#22-请求格式)
  - [2.3 回应格式](#23-回应格式)
  - [2.4 Content-Type 字段](#24-content-type-字段)
  - [2.5 Content-Encoding 字段](#25-content-encoding-字段)
  - [2.6 缺点](#26-缺点)
- [HTTP/1.1](#http11)
  - [3.1 持久连接](#31-持久连接)
  - [3.2 管道机制](#32-管道机制)
  - [3.3 Content-Length 字段](#33-content-length-字段)
  - [3.4 分块传输编码](#34-分块传输编码)
  - [3.5 其他功能](#35-其他功能)
  - [3.6 缺点](#36-缺点)
- [SPDY 协议](#spdy-协议)
- [HTTP/2](#http2)
...
> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [blog.csdn.net](https://blog.csdn.net/u013967628/article/details/78521908)

HTTP 协议是互联网的基础协议，也是网页开发的必备知识，最新版本 HTTP/2 更是让它成为技术热点。

本文介绍 HTTP 协议的历史演变和设计思路。

![alt](http://www.ruanyifeng.com/blogimg/asset/2016/bg2016081901.jpg)
...
![alt](https://img-blog.csdnimg.cn/20181118165833481.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTM5Njc2Mjg=,size_16,color_FFFFFF,t_70)
